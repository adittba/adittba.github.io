// vitepress/config.js or config.mjs
...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', href: 'https://adittba.github.io/assets/logo.svg', type: 'image/x-icon' }] // Add the favicon link here
  ],
  themeConfig: {
    // Add your logo configuration here
